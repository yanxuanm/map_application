...
static const vector<t_color> predef_colors = {
    t_color(0xFF, 253, 0xFF), // "white"
    t_color(0x00, 0x00, 0x00), // "black"
    t_color(209, 217, 220), // "grey55"
    t_color(238, 243, 246), // "grey75"
    t_color(243, 148, 182), // "red"
    t_color(0xFF, 0xA5, 0x00), // "orange"
    t_color(253, 251, 168), // "yellow"
    t_color(180, 232, 158), // "green"
    t_color(0x00, 0xFF, 0xFF), // "cyan"
    t_color(154, 206, 254), // "blue"
    ...
    t_color(255, 221, 80),//"orangeyellow"
    t_color(129, 192, 80), //"grassgreen"
    t_color(255, 218, 94),//"yelloworange"
    t_color(253, 240, 190),//"cream"
    t_color(153, 204, 255),//"lightblue"
    t_color(160, 160,160),//"darkdarkgray"
    t_color(0, 128,255),//"darkblue"
...
void set_visible_world_1(const t_bound_box& bounds) {
    /* Sets the coordinate system the user wants to draw into.          */
