...
SUITE(street_queries_perf) {
    ...
    TEST_FIXTURE(MapFixture, street_ID_from_name) {
        ...
        expected = {153,154,189,211,212,216,1475,6652};
        actual = find_street_ids_from_name("Highway 401");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {464,3833};
        actual = find_street_ids_from_name("To Highway 401");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {221};
        actual = find_street_ids_from_name("Highway 401 Westbound Collectors");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        //zxc
        
        expected = {20392,20421,20422,20423,20424,20425,20426,20427,20428,20429,20430,20431};
        ...
        expected = {231};
        actual = find_street_ids_from_name("Ontario Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {20794,20795};
        actual = find_street_ids_from_name("Life Saving Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {20726,20727,20728};
        actual = find_street_ids_from_name("Private Lane");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        ...
        expected = {2515,3442,3443,3444,4721,6622};
        actual = find_street_ids_from_name("Highway 407");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        ...
        expected = {};
        actual = find_street_ids_from_name("Life Is So Hard");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {};
        actual = find_street_ids_from_name("青年路");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
